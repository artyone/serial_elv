...
class App(tk.Tk):
    ...
    def set_fout(self, channel_number):
        ...
        try:
            ...
            message = f'Частота устанровлена. timeout: {timeout}, baudrate: {baudrate}'
            message += f'\nOтвет: {answer}'
    ...
    def change_CH1_state(self):
        ...
        try:
            answer = self.program.switch_CH1_state(self.lb_com.current(), timeout, baudrate)
            if answer:
    ...
    def change_CH2_state(self):
        ...
        try:
            answer = self.program.switch_CH2_state(self.lb_com.current(), timeout, baudrate)
            if answer:
                if self.program.state_CH1:
                    message += 'FOUT1 ON - '
                else:
    ...
    def __grid_interface(self):
        ...
        self.lbl_timeout.grid(row=1, column=0, pady=5, padx=4, sticky='e')
        self.ent_timeout.grid(row=1, column=1, pady=5, padx=4, sticky='we')
        self.lbl_baudrate.grid(row=1, column=2, pady=5, padx=4, sticky='e')
        self.ent_baudrate.grid(row=1, column=3, pady=5, padx=4, sticky='we')
        self.lbl_fclk.grid(row=2, column=0, pady=5, padx=4, sticky='e')
        self.ent_fclk.grid(row=2, column=1, pady=5, padx=4, sticky='we')
        self.lbl_fclk_mghz.grid(row=2, column=2, pady=5, padx=4, sticky='w')
        self.btn_fclk_edit.grid(row=2, column=5, pady=5, padx=4, sticky='we')
        self.lbl_fout1.grid(row=3, column=0, pady=5, padx=4, sticky='e')
        self.ent_fout1.grid(row=3, column=1, pady=5, padx=4, sticky='we')
        self.lbl_fout1_mghz.grid(row=3, column=2, pady=5, padx=4, sticky='w')
        self.lb_fout1.grid(row=3, column=3, pady=5, padx=4, sticky='we')
        self.btn_fout1_set.grid(row=3, column=4, pady=5, padx=4, sticky='we')
        self.btn_fout1_on.grid(row=3, column=5, pady=5, padx=4, sticky='we')
        self.lbl_fout2.grid(row=4, column=0, pady=5, padx=4, sticky='e')
        self.ent_fout2.grid(row=4, column=1, pady=5, padx=4, sticky='we')
        self.lbl_fout2_mghz.grid(row=4, column=2, pady=5, padx=4, sticky='w')
        self.lb_fout2.grid(row=4, column=3, pady=5, padx=4, sticky='we')
        self.btn_fout2_set.grid(row=4, column=4, pady=5, padx=4, sticky='we')
        ...
        self.txt_logs.grid(row=5, column=1, pady=5, padx=4,
                           sticky='w', columnspan=5)
        self.geometry(self.center_window(width=700, height=350))
